...
const MysteryWord = () => {
  ...
  const handleContinueToInput = (area: 'left' | 'center' | 'right') => {
    setAlternateRevealEnabled(area === 'left' || area === 'right');
    setCustomWordsMode(area === 'right');
        ...
        {stage === 'customWords' && (
          <div className="text-center space-y-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold">
              {t('mysteryWord.customWordsTitle')}
            </h2>
            <Card className="p-8">
              <div className="space-y-6">
                <p className="text-muted-foreground">
                  {t('mysteryWord.customWordsDescription')}
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {customWords.map((word, index) => (
                    <Input
                      ...
                      placeholder={t('mysteryWord.customWordsPlaceholder', { number: index + 1 })}
                ...
                >
                  {t('mysteryWord.customWordsContinue')}
                </Button>
              </div>
            </Card>
          </div>
              ...
              <div className="space-y-6">
                ...
                {customWordsMode && (
                  <p className="text-sm text-primary font-medium">
                    {t('mysteryWord.customWordsReminder')}
                  </p>
                )}
                <Input
                  type="text"
