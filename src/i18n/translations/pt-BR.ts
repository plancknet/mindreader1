export const ptBR = {
  ...
  mysteryWordInstructions: {
    ...
    step1Title: 'Card 1 - Categoria Escolhida',
    step1Text: 'A categoria escolhida será determinada pela quantidade de palavras da primeira interação. Uma palavra para a categoria "Animal", duas palavras para a categoria "Fruta" e três palavras para a categoria "País".',
    step2Title: 'Card 2 - Indicação das letras da Palavra Misteriosa',
    ...
    step3Title: 'Card 3 - Lista de Possibilidades',
    ...
    step4Title: 'Card 4 - Definindo a Palavra Misteriosa',
