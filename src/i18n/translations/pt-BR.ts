export const ptBR = {
  ...
  pontaCartaInstructions: {
    ...
    cardLabels: {
      aceOfSpades: 'As de Espadas',
      aceOfHearts: 'As de Copas',
      sevenOfClubs: '7 de Paus',
      sevenOfDiamonds: '7 de Ouros',
    },
  },
  mixDeCartasInstructions: {
    ...
    stepByStep: 'Passo a passo',
    steps: {
      step1: 'Transforme a carta em número 1-52. Some 13 para cada bloco de naipe até chegar ao desejado. Espadas valem 1-13, Copas começam em 14, Ouros em 27 e Paus em 40. Exemplo: {card} fica na posição {index} porque (Copas = 13 cartas antes) + posição do 7 dentro do naipe.',
      step2: 'Associe cada uma das 6 posições a um valor fixo. Seguindo o sentido escolhido pelo app, as cartas representam os valores {values} (começando em {direction}). Você só precisa saber que sempre haverá os valores 32, 16, 8, 4, 2 e 1 colocados em linha.',
      step3: 'Descubra o sentido olhando a âncora. A menor carta em valor (normalmente um número baixo de Espadas) aparece na extremidade de onde você deve começar a ler. Se ela estiver à direita, leia da direita para a esquerda e atribua os valores nessa ordem; se estiver à esquerda, faça o contrário.',
      step4: 'Soma das cores = número da carta. Percorra as seis cartas adicionando o valor da posição toda vez que ela for vermelha. Se a carta for preta, some zero. A soma final é exatamente o número 1-52 da carta escolhida - basta localizar na tabela do passo 1.',
    },
    animatedExample: 'Exemplo animado',
    exampleText: 'No exemplo abaixo, a menor carta é o 3 de Espadas, localizado à direita, então aplicamos os valores na ordem {direction}. Somamos os valores exibidos nos cartões vermelhos e ignoramos os pretos. A soma resultante é {index}, o que nos leva de volta ao {card}.',
    anchor: 'Âncora',
  ...
  jogoVelhaBruxaInstructions: {
    ...
    note: 'Mantenha este papel oculto até o final para reforçar o impacto da previsão da sua tia.',
  },
  googleMimeInstructions: {
    ...
    couldNotLoadCode: 'Não foi possível carregar o código. Tente novamente.',
    stepByStep: 'Passo a passo',
    steps: [
  ...
  euJaSabia2Instructions: {
    ...
    loadingAdminVideo: 'Carregando vídeo do admin...',
    adminVideoUnavailable: 'Vídeo do admin indisponível.',
    maskSection: 'Máscara numérica',
    maskSteps: [
    ...
    executionSection: 'Execução da mágica',
    executionSteps: [
    ...
    note: 'Sempre informe o número com 2 dígitos para garantir a revelação correta.',
  },
};
